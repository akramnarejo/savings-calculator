...
function Main() {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object().shape({
      leaseCost: yup
        .string()
        .matches(/[0-9]+/, "Invalid (Enter digits).")
        .required("Required.")
        .nullable(),
      portfolio: yup
        .string()
  ...
  useEffect(() => {
    ...
    if (totalInvestment) {
      ...
      setCostSF(
        totalInvestment / ((+values.portfolio + +values.estNeeds) * year)
      );
    }
  }, [
    totalSavings,
    ...
    <Container>
      ...
      >
          ...
          <form onSubmit={handleSubmit}>
                  ...
                  <Box className="textfieldBox">
                    <Box className="innerBox">
                      ...
                      <input
                        ...
                        onBlur={handleBlur}
                        onChange={(e) =>
                          setFieldValue("leaseCost", e.target.value)
                        }
                      />
                    </Box>
                    <Typography
                  ...
                  <Box className="textfieldBox">
                    <Box className="innerBox">
                      ...
                      <input
                        ...
                        onBlur={handleBlur}
                        onChange={(e) =>
                          setFieldValue("capexSpends", e.target.value)
                        }
                      />
                    </Box>
                    <Typography
                  ...
                  <Box className="textfieldBox">
                    <Box className="innerBox">
                      ...
                      <input
                        ...
                        onBlur={handleBlur}
                        onChange={(e) =>
                          setFieldValue("estNeeds", e.target.value)
                        }
                      />
                    </Box>
                    <Typography
            ...
            >
              <Typography
                variant="subtitle2"
                component="p"
                sx={{ fontWeight: 700, fontSize: { md: 20, xs: 16 } }}
              >
                Select Duration:{" "}
              </Typography>
              <Box
        ...
        <Box
          ...
          sx={{
            width: "100%",
            padding: { sm: "10px 45px", lg: "20px 85px" },
        ...
        >
          <Typography
            mt={1}
            component="h3"
            sx={{ fontSize: { sm: "20px", md: "24", lg: "26px" } }}
            px={2}
            py={1}
            borderRadius={1}
            boxSizing="border-box"
          ...
          >
            <Box display="flex" alignItems="center" gap={0.2}>
              <Tooltip
                title="1% savings on new space over the life of the lease."
                placement="right"
              >
            ...
            <Typography
              className={isBlurred ? "blurr" : ""}
              component="p"
              lineHeight={0.5}
              color="#233a72"
              fontSize={{ md: 28, xs: 24 }}
            >{`$${Math.round(costAvoidance).toLocaleString()}`}</Typography>
          </Box>
          <Box
            width="100%"
            sx={{
          ...
          >
            <Box display="flex" alignItems="center" gap={0.2}>
              <Tooltip
                title="2.5% Capex savings across current portfolio tenor."
                placement="right"
              >
                <InfoOutlinedIcon fontSize="small" />
              </Tooltip>
            ...
            <Typography
              ...
              color="#233a72"
              fontSize={{ md: 28, xs: 24 }}
            >{`$${Math.round(spaceOptimization).toLocaleString()}`}</Typography>
          </Box>
          <Typography
            mt={1}
            component="h3"
          ...
          >
            ...
            <Typography
              ...
              color="#233a72"
              fontSize={{ md: 28, xs: 24 }}
            >{`$${totalInvestment.toLocaleString()}`}</Typography>
          </Box>
          <Box
            width="100%"
            sx={{
          ...
          >
            ...
            <Typography
              ...
              color="#233a72"
              fontSize={{ md: 28, xs: 24 }}
            >{`$${Math.round(totalSavings).toLocaleString()}`}</Typography>
          </Box>
          <Divider />
          <Box
            width="100%"
          ...
          >
            ...
            <Typography
              ...
              color="#233a72"
              fontSize={{ md: 28, xs: 24 }}
            >{`$${Math.round(netSavings).toLocaleString()}`}</Typography>
          </Box>
          <Typography
            mt={1}
            component="h3"
          ...
          >
            ...
            <Typography
              ...
              color="#233a72"
              fontSize={{ md: 28, xs: 24 }}
            >{`${Math.fround(roi * 100)}%`}</Typography>
          </Box>
          <Box
            width="100%"
            sx={{
          ...
          >
            ...
            <Typography
              ...
              color="#233a72"
              fontSize={{ md: 28, xs: 24 }}
            >{`$${Math.fround(costSF).toFixed(2)}`}</Typography>
          </Box>
